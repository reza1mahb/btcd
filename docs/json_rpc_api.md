...
* Unlike bitcoind that has the wallet and chain intermingled in the same process
  ...
  [btcwallet](https://github.com/binance-chain/btcwallet).
...
such as [btcwallet](https://github.com/binance-chain/btcwallet) for inter-process
...
[rpcclient](https://github.com/binance-chain/btcd/tree/master/rpcclient) package.
...
[rpcclient](https://github.com/binance-chain/btcd/tree/master/rpcclient) package to connect with
