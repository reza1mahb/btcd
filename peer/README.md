...
[![GoDoc](https://img.shields.io/badge/godoc-reference-blue.svg)](https://pkg.go.dev/github.com/binance-chain/btcd/peer)
...
```bash
$ go get -u github.com/binance-chain/btcd/peer
```

## Examples

* [New Outbound Peer Example](https://pkg.go.dev/github.com/binance-chain/btcd/peer#example-package--NewOutboundPeer)  
